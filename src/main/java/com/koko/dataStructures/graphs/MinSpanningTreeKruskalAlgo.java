...
public class MinSpanningTreeKruskalAlgo {


    // Solution:
    // Sort all nodes using Collections and Comparator.
    // Iterate on nodes.
    // Check if parent are same, skip.
    // If parent are diff, do a Union, update the cost with edge, and add in final array.
