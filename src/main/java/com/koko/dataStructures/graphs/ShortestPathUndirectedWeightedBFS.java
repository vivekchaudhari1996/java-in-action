...
public class ShortestPathUndirectedWeightedBFS {

    // Dijkstra's Algo

    // Solution:
    // Use PriorityQueue (Min Heap) and dist array.
    // Queue sorted weight wise for each node.

    // TC: O(N+E)*log N  ~ O(NlogN)
    // log N for PQ sorting.
    // SC: O(N)
