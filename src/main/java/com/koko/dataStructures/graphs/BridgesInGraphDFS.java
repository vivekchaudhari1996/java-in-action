...
public class BridgesInGraphDFS {

    // Solution:
    // Take two arrays time of insertion[], and lowestTime[]
    // Do DFS
    // and follow below conditions to populate both.
    // low[it] > tin[node]
    // above condition tells for a bridge.
